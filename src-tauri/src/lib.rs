...
use fem::{tet10::Tet10, quadrature::TetQuadrature, mesh::TetMesh, tetgen::cmd_tetrahedralize};
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![export_layer_files, compute_smart_split, get_debug_eval, import_mesh, cmd_tetrahedralize])
