...
export {generateDovetailPoints, getTessellatedBoardOutline, findSafeSplitLine, checkSplitPartSizes, collectGlobalObstacles} from "./splitUtils"; // Re-export for external use
